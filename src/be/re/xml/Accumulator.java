 ...
 * instance of it can be reused. The client must call <code>startDocument</code>
 * and <code>endDocument</code>.
 *
 * @author Werner Donn\u00e9
 */
public class Accumulator extends XMLFilterImpl
{
    ...
    /**
     * This installs an accumulator before <code>filter</code>. You would call
     * it in <code>startElement</code>, and initialize it with the incoming
     * event, which you don't let go through.
     */
    ...
    private static void setPrefixMappings(Element element, Map<String, String> mappings)
    {
    ...
    {
        Element element= document.createElementNS("".equals(namespaceURI) ? null : namespaceURI, qName);
