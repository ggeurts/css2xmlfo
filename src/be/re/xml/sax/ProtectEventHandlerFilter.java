...
/**
 * If the parent already has an entity resolver on it, it will not be replaced
 * by this filter.
 *
 * @author Werner Donn\u00e9
 */
public class ProtectEventHandlerFilter extends XMLFilterImpl
{
    ...
    public ProtectEventHandlerFilter(boolean entityResolver, boolean errorHandler)
    {
        this.entityResolver = entityResolver;
        this.errorHandler = errorHandler;
    }

    public ProtectEventHandlerFilter(boolean entityResolver, boolean errorHandler, XMLReader parent)
    {
        super(parent);
        this.entityResolver = entityResolver;
        this.errorHandler = errorHandler;
