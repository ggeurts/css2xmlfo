...

{
            ...
            ) throws IOException, CSSToXSLFOException
    {
        ...
        try
        {
            ...
            SAXSource saxSource = converter.createSAXSource(
                    new InputSource(in), baseUrl, userAgentStyleSheet, parameters, preprocessor, null);

            if (configuration != null)
            {
                new FormatterImpl(new StreamSource(configuration.toString()))
                        .render(saxSource,
