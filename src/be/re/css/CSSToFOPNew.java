...
public class CSSToFOPNew
{
    ...
    public static void convert(
            ...
            String format,
            File configFile,
            boolean validate) throws IOException, CSSToXSLFOException
    {
        convert(in, out, baseUrl, userAgentStyleSheet, catalog, parameters, preprocessors, format, configFile, validate, null);
    }
    ...
    public static void convert(
            ...
            File configFile,
            boolean validate,
            FOUserAgent agent) throws IOException, CSSToXSLFOException
    {
        try
        {
            ...
            if (configFile != null)
            {
                fopFactory.setUserConfig(new DefaultConfigurationBuilder().buildFromFile(configFile));
            }
            if (agent == null)
            {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        parameters.put("base-url", baseUrl != null
                ? baseUrl.toString() 
            ...
            usage(int code)
    {
        ...
        System.err.println("  [url_or_filename]: the input document, uses stdin by default");
        System.err.println("  [parameter=value ...] ");
        System.err.println("  -fop options: the rest of the command-line is for FOP");
        System.err.println();
