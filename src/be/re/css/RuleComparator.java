...
/**
 * A comparator for sorting rules from least to most specific. The rules must be
 * split, i.e. they should have exactly one property.
 *
 * @author Werner Donn\u00e9
 */
class RuleComparator implements Comparator<Rule>
{
    public int compare(Rule rule1, Rule rule2)
    {
        ...
        if (result == 0)
        {
            result = (!property1.getImportant() && property2.getImportant()
                    ? -1
