...
{
    private static final Set<String> allowedPlaces = new HashSet<>(Arrays.asList(new String[]
    {
    ...
    private void accumulateFOMarker(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException
    {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException
    {
        ...
        else
        {
            ...
            String display = parentDisplay != null && parentDisplay.equals("none")
                    ? "none" 
                    : atts.getValue(Constants.CSS, "display");

            if ((Constants.CSS != namespaceURI || !"fo-marker".equals(localName)) && allowedPlaces.contains(display))
            {
                flushFOMarkers();
            }
